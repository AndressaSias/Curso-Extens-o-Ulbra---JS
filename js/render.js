function renderMenu(dom, category) {
	category = category || 'all';
	_.eachChild(dom, function(child) {		
		...
		.forEach(function(items) {
			...
			items
				.forEach(function(item) {
					const produto = createProduct(item);
